{ $Id: DUnitMainForm.pas,v 1.1 2001/07/05 13:02:47 chrismo Exp $ }
...
const
  rcs_id :string = '#(@)$Id: DUnitMainForm.pas,v 1.1 2001/07/05 13:02:47 chrismo Exp $';
...
begin
  ...
  begin
    RootSuite.AddTest(LoadModuleTests(ParamStr(i)));
  end;
  inherited Suite := RootSuite;
end;
